...
class Ui_DockWidget(object):
    def setupUi(self, DockWidget):
        ...
        self.CarritoButton = QPushButton(self.dockWidgetContents)
        self.CarritoButton.setGeometry(QtCore.QRect(480, 10, 41, 41))
        self.CarritoButton.setStyleSheet("background-color:rgb(170, 170, 255);\nborder-style:solid;\nborder-radius:20px;\nborder-width:2px;\nborder-color:rgb(159, 115, 255);")
        self.CarritoButton.setText("")
        icon = QIcon()
        icon.addPixmap(QPixmap("C:\\Users\\denis\\Downloads\\../../../../../../../Downloads/carpeta/pngwing.com.png"), QIcon.Mode.Normal, QIcon.State.Off)
        self.CarritoButton.setIcon(icon)
        self.CarritoButton.setIconSize(QtCore.QSize(35, 35))
        self.CarritoButton.setObjectName("CarritoButton")
        self.BusquedaButton_2 = QPushButton(self.dockWidgetContents)
        self.BusquedaButton_2.setGeometry(QtCore.QRect(540, 10, 41, 41))
        self.BusquedaButton_2.setStyleSheet("background-color:rgb(170, 170, 255);\nborder-style:solid;\nborder-radius:20px;\nborder-width:2px;\nborder-color:rgb(159, 115, 255);")
        self.BusquedaButton_2.setText("")
        icon1 = QIcon()
        icon1.addPixmap(QPixmap("C:\\Users\\denis\\Downloads\\../../../../../../../Downloads/carpeta/lupa.png"), QIcon.Mode.Normal, QIcon.State.Off)
        self.BusquedaButton_2.setIcon(icon1)
        self.BusquedaButton_2.setIconSize(QtCore.QSize(30, 30))
        self.BusquedaButton_2.setObjectName("BusquedaButton_2")
